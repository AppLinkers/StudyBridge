...
public class ToDoFragment extends Fragment {
    ...
    private void setData(){
        ToDo toDo1 = new ToDo(null,1,null,null,"문제집 5페이지 풀기",null,"2022/03/28",null);
//        ToDo toDo2 = new ToDo(null,1,null,null,"알고리즘 문제 복습",null,"2022/03/26",null);
        ToDo toDo3 = new ToDo(null,0,null,null,"턱걸이 15회.",null,"2022/04/28",null);
        ToDo toDo4 = new ToDo(null,2,null,null,"벤치프레스 10회",null,"2022/03/23",null);
