...
public class ToDoMentorInsdieDetailHolder extends RecyclerView.ViewHolder{
    ...
    public void onBind(FindAssignedToDoRes data){
        ...
        todo = new ToDo(data.getToDoId(), data.getStudyId(), data.getStatus(), data.getMentorName(), data.getMenteeName(), data.getTask(), data.getExplain(), data.getDueDate(), data.getFeedBack());
